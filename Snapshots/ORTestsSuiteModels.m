...
+ (ORTestCase *)caseFromString:(NSString *)line
{
    ...
    if (components.count == 2 && endComponents.count == 2) {
        ...
        // We avoid hitting ends of words by adding the space, but that potentially misses the first one
...
+ (instancetype)referenceFromString:(NSString *)line
{
    ...
    // /Users/orta/dev/ios/eigen/Artsy_Tests/View_Controller_Tests/Live_Auction/LiveAuctionBidHistoryViewControllerTests.swift:28: error: -[Artsy_Tests.LiveAuctionBidHistoryViewControllerTests cells__looks_right_for_open_UsersortadevioseigenArtsyTestsViewControllerTestsLiveAuctionLiveAuctionBidHistoryViewControllerTestsswift_21] : failed - , got snapshot nil successfully recorded, replace recordSnapshot with a check
